...
export function Scene8() {
  const topicsList = [
    { name: 'Everything Is a Function', acc: '98%', status: 'Strong', color: 'text-[#10B981]', bg: 'bg-[#10B981]/10' },
    { name: 'Church Numerals', acc: '92%', status: 'Strong', color: 'text-[#10B981]', bg: 'bg-[#10B981]/10' },
    { name: 'Booleans & Logic', acc: '75%', status: 'Developing', color: 'text-[#FBBF24]', bg: 'bg-[#FBBF24]/10' },
    { name: 'The Y Combinator', acc: '45%', status: 'Weak', color: 'text-[#EF4444]', bg: 'bg-[#EF4444]/10' },
  ];
